      ...
      <Box sx={{ maxWidth: 900, mx: "auto" }}>
        <Box sx={{
          ...
          <Box>
            ...
            <Typography sx={{ lineHeight: 2, color: "text.secondary" }}>
              {t("about.description")}
            </Typography>
          </Box>
        </Box>
        ...
        <Paper elevation={0} sx={{ p: { xs: 3, md: 5 }, borderRadius: 4, border: `1px solid ${brandColors.sand}` }}>
          ...
          <Box component="ul" sx={{ pl: 3, "& li": { mb: 1, color: "text.secondary" } }}>
            <li><strong>Kundali Reading</strong> — Detailed birth chart analysis</li>
            <li><strong>Vastu Consultation</strong> — Home and office energy alignment</li>
            <li><strong>Astrology Guidance</strong> — Career, health, relationships</li>
            <li><strong>Meditation & Sadhna</strong> — Personalized spiritual practices</li>
            <li><strong>Puja & Rituals</strong> — Sacred ceremonies and remedies</li>
            <li><strong>Spiritual Counseling</strong> — Life guidance and clarity</li>
          </Box>
        </Paper>
      </Box>
    </Box>
